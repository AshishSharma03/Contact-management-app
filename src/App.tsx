...
function App() {
  ...
  return (
    <div >
      ...
      :""}
        {/* <SideDrawer /> */}
      <Navbar  needHamBurger={!isOpen} opneSideBar={()=>setIsOpen(true)} /> 
      <div className="flex-1 flex">
        ...
        <div className="h-[20vh]  p-4 flex justify-center items-center">
          <button className="py-2 p-5 bg-white  rounded-sm font-semibold" onClick={()=>{setOpen(true)}} >Create contact</button>
        </div>
